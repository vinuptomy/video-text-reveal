...
const Index: React.FC = () => {
  return (
    <div className="overflow-hidden">
      ...
      <footer className="bg-blue-950 py-16 px-4 md:px-8 text-white">
        <div className="max-w-7xl mx-auto text-center">
          <div className="flex items-center justify-center mb-6">
            <Sparkles className="text-blue-300 w-5 h-5 mr-2" />
            <h2 className="text-2xl font-light text-white">Inspired by imagination</h2>
            <Sparkles className="text-blue-300 w-5 h-5 ml-2" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-10">
            <div className="flex flex-col items-center p-4">
              ...
              <p className="text-blue-200">contact@munter.ai</p>
            </div>
            <div className="flex flex-col items-center p-4">
