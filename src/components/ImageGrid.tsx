  ...
  return (
    <section ref={sectionRef} className="py-20 px-4 md:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-light text-center mb-4">Thoughtfully Crafted</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {images.map((image, index) => (
            ...
            >
              <div className="image-container shadow-lg aspect-[3/4] mb-6 overflow-hidden">
                <img 
                  src={image.src} 
                  alt={image.alt}
